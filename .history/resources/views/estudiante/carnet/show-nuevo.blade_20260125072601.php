    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6">
            ...
            <div class="text-center mb-4">
                <a href="{{ route('estudiante.carnet.descargar-pdf') }}" class="btn btn-light btn-lg shadow-sm me-2">
...
<style>
    * {
    ...
    .status-dot {
        ...
        width: 18px;
        height: 18px;
        background: {{ $carnet->estado === 'activo' ? '#28A745' : '#DC3545' }};
    ...
    .status-active {
        color: {{ $carnet->estado === 'activo' ? '#28A745' : '#DC3545' }};
    }
