...
<head>
    ...
    <style>
        ...
        * {
        ...
        .brand-logo-nav .ist { color: var(--dorado); }
        .brand-logo-nav .sep { color: var(--dorado); margin: 0 4px; opacity: 0.5; font-weight: 400; }
        .brand-logo-nav .name { color: #fff; font-size: 0.82rem; letter-spacing: 0.6px; margin-left: 7px; }
        ...
        .brand h1 span { color: var(--dorado); }
        ...
        .section-title i { color: var(--dorado); }
...
<body>
    ...
    <nav class="top-nav">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="brand-logo-nav" href="{{ route('login') }}">
            ...
            <span style="font-size:12px; color:rgba(255,255,255,0.4); letter-spacing:0.5px;">
                Sistema de Carnetización hecha por Kevin Huilca
            </span>
        </div>
    </nav>
    ...
    <div class="register-wrapper">
        ...
        <div class="brand">
            <div class="brand-icon-box">
                <img src="{{ asset('images/LogoISTPET.png') }}" alt="ISTPET" style="width:85px;height:85px;object-fit:contain;filter:drop-shadow(0 2px 6px rgba(0,0,0,0.25));">
            </div>
        ...
        <div class="register-card">
            ...
            <form action="{{ route('registro.post') }}" method="POST" enctype="multipart/form-data" id="registroForm">
                ...
                {{-- Datos Personales --}}
                <div class="section-title mt-4"><i class="bi bi-person-vcard"></i>Datos Personales</div>
                ...
                {{-- Contacto --}}
                <div class="section-title mt-4"><i class="bi bi-envelope"></i>Información de Contacto</div>
                ...
                {{-- Contraseña --}}
                <div class="section-title mt-4"><i class="bi bi-shield-lock"></i>Contraseña de Acceso</div>
    ...
    {{-- Footer --}}
    <footer style="position:relative;z-index:1;background:rgba(0,0,0,0.25);border-top:1px solid rgba(196,168,87,0.15);padding:12px 0;text-align:center;">
        <p style="font-size:12px;color:rgba(255,255,255,0.35);margin:0;"><em style="color:var(--dorado);opacity:0.7;font-style:italic;">Excelencia Académica · Atrévete a cambiar el mundo</em></p>
    </footer>
