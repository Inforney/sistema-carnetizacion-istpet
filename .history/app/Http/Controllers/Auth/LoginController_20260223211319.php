        ...
        if ($estudiante) {
            ...
            if ($estudiante->estaBloqueado()) {
                return back()->withInput()->with(
                    'error',
                    'Tu cuenta ha sido bloqueada. Por favor, contacta con el área de administración del instituto para más información. Puedes escribir a administracion@istpet.edu.ec o llamar al (.'
                );
            }
