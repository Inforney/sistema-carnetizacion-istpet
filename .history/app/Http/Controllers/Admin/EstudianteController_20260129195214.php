...
class EstudianteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                ...
                $rutaFoto = 'storage/fotos_perfil/' . $nombreFoto;

                // Crear directorio si no existe
                if (!file_exists(public_path('storage/fotos_perfil'))) {
                    mkdir(public_path('storage/fotos_perfil'), 0755, true);
                }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            if ($estudiante->foto_url && file_exists(public_path($estudiante->foto_url))) {
                unlink(public_path($estudiante->foto_url));
            }
