            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="vertical-align:middle; text-align:right;">
                        ...
                        <div style="color:#fff;font-size:8.5px;font-weight:bold;">{{ $generadoEn }}</div>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="height:253mm; background-color:#eef0f5; vertical-align:middle; text-align:center; padding:0;">
            ...
            <table width="130mm" style="width:130mm; height:218mm; border-collapse:collapse; table-layout:fixed; box-shadow:0 3mm 12mm rgba(0,0,0,0.40); margin:0 auto;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="height:53mm;background-color:#1a2342;padding:10px 8px 8px 8px;text-align:center;vertical-align:middle;">
                        ...
                        <img src="{{ public_path($usuario->foto_url) }}" width="100" height="100" style="border-radius:50%;object-fit:cover;border:4px solid #C4A857;display:inline-block;">
                        @else
                ...
                <tr>
                    <td style="height:84mm;background:#fff;vertical-align:top;border-left:6px solid #C4A857;padding:10px 14px 8px 14px;">
                        <div style="font-size:15px;font-weight:bold;color:#222C57;line-height:1.25;margin-bottom:7px;padding-bottom:6px;border-bottom:1px solid rgba(196,168,87,0.4);">{{ $usuario->nombreCompleto }}</div>
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="width:50%;padding-right:6px;padding-bottom:7px;vertical-align:top;">
                                    <div style="font-size:7.5px;color:#C4A857;text-transform:uppercase;font-weight:bold;letter-spacing:0.5px;line-height:1;margin-bottom:2px;">{{ $usuario->tipo_documento === 'pasaporte' ? 'Pasaporte' : 'Cédula de Identidad' }}</div>
                                    <div style="font-size:13px;color:#222C57;font-weight:bold;line-height:1.2;">{{ $usuario->cedula }}</div>
                                </td>
                                <td style="width:50%;padding-bottom:7px;vertical-align:top;">
                                    ...
                                    <div style="font-size:12px;color:#222C57;font-weight:bold;line-height:1.2;">{{ $usuario->ciclo_nivel }}</div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding-bottom:7px;vertical-align:top;">
                                    ...
                                    <div style="font-size:13px;color:#222C57;font-weight:bold;line-height:1.2;">{{ $usuario->carrera ?? 'N/A' }}</div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding-bottom:7px;vertical-align:top;">
                                    ...
                                    <div style="font-size:11px;color:#222C57;font-weight:bold;line-height:1.2;">{{ $usuario->correo_institucional }}</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="padding-left:10px;vertical-align:middle;border-left:1px solid rgba(196,168,87,0.25);">
                                    ...
                                    <div style="font-size:12px;color:#fff;font-weight:bold;line-height:1.3;margin-bottom:6px;">{{ $fechaEmision }}</div>
                                    ...
                                    <div style="font-size:12px;color:#C4A857;font-weight:bold;line-height:1.3;margin-bottom:7px;">{{ $fechaVencimiento }}</div>
            ...
            <div style="margin-top:4mm;text-align:center;">
                <span style="font-size:8px;color:#aaa;letter-spacing:0.5px;">✂ Recortar por los bordes · {{ $usuario->cedula }}</span>
            </div>
        ...
        <td style="height:20mm; background-color:#222C57; padding:4mm 12mm; vertical-align:middle;">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="vertical-align:middle;text-align:right;">
                        <div style="color:rgba(255,255,255,0.30);font-size:6.5px;">Documento generado automáticamente<br>por el Sistema de Carnetización</div>
                    </td>
                </tr>
            </table>
        </td>
